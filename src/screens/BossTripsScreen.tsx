/**
 * Boss Trips Screen
 * List of boss (owner/family) trips; HOD can add/edit; calendar to choose dates when adding
 */
...
const TRIP_TYPE = 'BOSS' as const;

export const BossTripsScreen = ({ navigation }: any) => {
  ...
  const cardColor = tripColors?.boss ?? DEFAULT_COLORS.boss;
  ...
  if (!vesselId) {
    return (
      <View style={styles.center}>
        <Text style={styles.message}>Join a vessel to see boss trips.</Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptyText}>No boss trips yet</Text>
          {isHOD && (
